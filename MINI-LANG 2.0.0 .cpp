...
public:
    ...
    cout<<"Datatype : ";
    if(obj.datatype=="int"){cout<<"Integer";}
    else if(obj.datatype=="float"){cout<<"Float";}
    else if(obj.datatype=="bool"){cout<<"Boolean";}
    else{cout<<"String";}
    cout<<endl;}};
//COPY VARIABLE
...
public:
    ...
    cout<<endl<<"Variable Copied Successfully."<<endl;}};
//Interpreter
class Interpreter
{private:
...
public:
    ...
    {vector<string> tokens = tokenize(line);
     if(tokens.size()==0)
        ...
        else if(tokens[0]=="countvars")
        {commandQueue.push(new CountVarsCommand());}
        //Delete All Variables
        else if(tokens[0]=="clearvars")
        {commandQueue.push(new ClearVarsCommand());}
        //Type of Variable
        else if(tokens[0]=="type" && tokens.size()==2)
        {commandQueue.push(new TypeCommand(tokens[1]));}
        //Copy Data of One Variable into Another
        else if(tokens[0]=="copy" && tokens.size()==4 && tokens[2]=="into")
        {commandQueue.push(new CopyCommand(tokens[1],tokens[3]));}
        ...
        //Help Command
            ...
            {cout<<endl<<"================= AVAILABLE COMMANDS ================="<<endl;
             ...
             cout<<"copy <source> into <destination>"<<endl;
...
int main()
    ...
    {cout<<"--> ";
     ...
     cout<<"\n===================================================="<<endl;
     cout<<" Thank you for using MiniLang Interpreter"<<endl;
     cout<<" Version : 1.1.0"<<endl;
     cout<<" Interpreter Closed Successfully"<<endl;
     cout<<"===================================================="<<endl;
     return 0;}
